...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs/CMSSW/UserCode/yinglu/MC_Production/PhotonJet/photon30_GEN_SIM_DIGI.py,v $')
    )
...
# hiSignal??
process.load('Configuration.GenProduction.Pyquen_GammaJet_pt30_TuneZ2_Unquenched_2760GeV_cfi')
#process.load('Configuration.GenProduction.Pyquen_GammaJet_pt30_cfi')
