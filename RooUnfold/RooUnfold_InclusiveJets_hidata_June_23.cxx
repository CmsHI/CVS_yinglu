...
void RooUnfold_InclusiveJets_hidata_June_23(int method,int algo,bool useSpectraFromFile=0,char *spectraFileName = "pbpbSpectra.root", int doToy = 1) // algo 2 =akpu2 ; 3 =akpu3 ; 4 =akpu4 ;1 = icpu5
{
   #ifdef __CINT__
...
//   boundaries_pthat[6]=10000;
   ...
   // ================ pp PtBin ======================================================================
   const int nbinsPP_pthat = 7;
   Double_t boundariesPP_pthat[nbins_pthat+1];
   char *fileNamePP_pthat[nbins_pthat+1];
   Double_t xsectionPP[nbins_pthat+1];
   
   boundariesPP_pthat[0]=30;
   fileNamePP_pthat[0]="/d102/yjlee/hiForest2MC/Pythia30_HydjetDrum_mix01_HiForest2_v19.root";   
   xsectionPP[0]= 1.079e-02;

   boundariesPP_pthat[1]=50;
   fileNamePP_pthat[1]="/d102/yjlee/hiForest2MC/Pythia50_HydjetDrum_mix01_HiForest2_v19.root";   
   xsectionPP[1]= 1.021e-03;

   boundariesPP_pthat[2]=80;
   fileNamePP_pthat[2]="/d102/yjlee/hiForest2MC/Pythia80_HydjetDrum_mix01_HiForest2_v20.root";   
   xsectionPP[2]= 9.913e-05;

   boundariesPP_pthat[3]=120;
   fileNamePP_pthat[3]="/d102/yjlee/hiForest2MC/Pythia120_HydjetDrum_mix01_HiForest2_v21_ivan.root";   
   xsectionPP[3]= 1.128e-05;

   boundariesPP_pthat[4]=170;
   fileNamePP_pthat[4]="/d102/yjlee/hiForest2MC/Pythia170_HydjetDrum_mix01_HiForest2_v19.root";   
   xsectionPP[4]= 1.470e-06;

   boundariesPP_pthat[5]=200;
   fileNamePP_pthat[5]="/d102/yjlee/hiForest2MC/Pythia200_HydjetDrum_mix01_HiForest2_v21_ivan.root";   
   xsectionPP[5]= 5.310e-07;

   boundariesPP_pthat[6]=250;
   fileNamePP_pthat[6]="/d102/yjlee/hiForest2MC/Pythia250_HydjetDrum_mix01_HiForest2_v21_ivan.root";   
...
//   boundaries_pthat[6]=10000;
   ...
   // Read data file
   TFile *infData = new TFile("/d102/yjlee/hiForest2/HiForest-promptskim-hihighpt-hltjet80-pt90-v2_v3_part2.root");
...
//      TCanvas *c =new TCanvas(Form("c%d",i),Form("c%d",i),600,600);
   ...
   for (int i=0;i<nbinsPP_pthat;i++) {
      float scale=(xsectionPP[i]-xsectionPP[i+1])/dataPP[i]->tJet->GetEntries(Form("pthat>%.0f&&pthat<%.0f&&hiBin>28",boundariesPP_pthat[i],boundariesPP_pthat[i+1])); 
      cout <<"Loading PP pthat"<<boundaries_pthat[i]
           <<" sample, cross section = "<<xsection[i]
