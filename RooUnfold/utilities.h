...
static const int nbins_truth = 49;
static const double boundaries_truth[nbins_truth+1] = {
	0,15,30, 40,50, 60, 70, 80, 90, 100, 110, 120, 130, 140, 150, 160, 170,
...
static const double boundaries_recrebin[nbins_recrebin+1] = {
	30,40, 50, 60,70, 80, 90, 100, 110, 120, 130, 140, 150, 160, 170, 180, 200, 240, 300
};
...
*/
/*
static const int nbins_recrebin = 47;
static const double boundaries_recrebin[nbins_recrebin+1] = {
...
static const int nbins_recrebinM = 47;
static const double boundaries_recrebinM[nbins_recrebinM+1] = {
        30, 40, 50, 60, 70, 80, 90, 100, 110, 120, 130, 140, 150, 160, 170,
                180, 190, 200, 210, 220, 230, 240, 250, 260, 270, 280, 290, 300, 310,
                        320, 330, 340, 350, 360, 370, 380, 390, 400, 410, 420, 430, 440, 450,
...
Double_t TAA[nbins_cent] = { 25.9, 20.5, 11.6, 3.92, 0.98, 0.17 };
